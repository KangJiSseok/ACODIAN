...
/**
 * 업무일지 작성 보조를 위해 API 서버가 AI 서버를 동기 호출할 때 쓰는 설정값이다.
 */
@ConfigurationProperties(prefix = "ai.worklog-polish")
public record AiWorklogPolishProperties(
        String baseUrl,
    ...
    public AiWorklogPolishProperties {
